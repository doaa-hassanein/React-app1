...
const Portfolio = () => {
    ...
    return (
        <div>
            ...
            <section className='protfolio-sec h-75 mb-5'>
                <div className=" ">
                    <div className="pt-3 container">
                        <div title="protfolio section" style={{ color: '#2c3e50' }}>
                            <div className="text-center pt-4  protfolio-header">
                                <h1 className="text-uppercase mb-3 fs-1 fw-bolder">Portfolio component</h1>
                        ...
                        <div className="row g-5">
                            <div className="col-lg-4 col-md-6">
                                <div className="inner" onClick={() => handleShow(img1)}>
                                    <img src={img1} alt="1" className='w-100 rounded-3' style={{ cursor: 'pointer' }} />
                            ...
                            <div className="col-lg-4 col-md-6">
                                <div className="inner" onClick={() => handleShow(img2)}>
                                    <img src={img2} alt="2" className='w-100 rounded-3' style={{ cursor: 'pointer' }} />
                                    <div className="desc rounded-3">
                                        <i className='fa-solid fa-plus text-white fa-9x'></i>
                                    </div>
                                </div>
                            ...
                            <div className="col-lg-4 col-md-6">
                                <div className="inner" onClick={() => handleShow(img3)}>
                                    <img src={img3} alt="3" className='w-100 rounded-3' style={{ cursor: 'pointer' }} />
                                    <div className="desc rounded-3">
                                        <i className='fa-solid fa-plus text-white fa-9x'></i>
                                    </div>
                                </div>
